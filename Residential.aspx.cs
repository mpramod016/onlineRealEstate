...
public partial class Residential : System.Web.UI.Page
{
    ...
    private void BindFarRepeater()
    {
        ...
        {
            using (SqlCommand cmd = new SqlCommand("select * from Propertytbl inner join  PropertyImagetbl on Propertytbl.PropertyId =PropertyImagetbl.PropertyId Where  Propertytbl.PropertyType='Residential'", con))
            {
