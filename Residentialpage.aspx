<%@ Page Title="" Language="C#" MasterPageFile="~/HomeMasterPage.master" AutoEventWireup="true" CodeFile="Residentialpage.aspx.cs" Inherits="Residentialpage" %>
        ...
        <div class="container">
            <div class="row all-text-white">
                <div class="col-md-12 align-self-center">
                    <h1 class="innerpage-title">Residential Page</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active"><a href="#"><i class="ti-home"></i>Home</a></li>
                            <li class="breadcrumb-item">Residential Page</li>
                        </ol>
                    </nav>
                </div>
            </div>
